...
CREATE DATABASE `powertac_tournament` CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
CREATE TABLE `powertac_tournament`.`brokers` (
  ...
  `brokerShort` VARCHAR(255)        NOT NULL,
...
CREATE TABLE `powertac_tournament`.`machines` (
  ...
  `machineUrl`    VARCHAR(255)            NOT NULL, /* Hostname of the machine */
  `visualizerUrl` VARCHAR(255)            NOT NULL,
...
CREATE TABLE `powertac_tournament`.`games` (
  ...
  `visualizerQueue` VARCHAR(255)                                                                                                                                               NOT NULL, /* name of visualizer output queue */
  `serverQueue`     VARCHAR(255)                                                                                                                                               NOT NULL, /* name of server input queue */
  `location`        VARCHAR(255)                                                                                                                                               NOT NULL,
  `simStartDate`    VARCHAR(255)                                                                                                                                               NOT NULL,
