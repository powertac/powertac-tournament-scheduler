...
public class ServerPanel
{
  ...
  public int LoadServerPanelFromDB (DbConnection db) throws Exception
  {
    ...
    ResultSet rs;
    String sql_select =
      "select ServerName, ServerNumber, IsPlaying from GameServers";
  ...
  public void publishDeployedServersToDB (DbConnection db, Server[] slist)
    throws Exception
  {
    int i, len;
    String wherestring = "", sql =
      "update PowerTAC.GameServers set IsPlaying = 1 where ";
