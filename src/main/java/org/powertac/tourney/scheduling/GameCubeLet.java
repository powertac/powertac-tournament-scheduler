...
public class GameCubeLet {
	...
	private int[] basegame; /* for a three player and 5 agents it will look like 11100 */
	...
	public void resetActualSums() {	 
		for(int i =0; i<nofagents; i++) {
			ActualSumArray[i] = 0;
		}
	}
	
	public void resetProposedSums() {
		for(int i =0; i<nofagents; i++) {
			ProposedSumArray[i] = 0;
		}
	}
	...
	public void initializeCombination() {
		System.arraycopy(ActualSumArray,0,ProposedSumArray,0, ActualSumArray.length);
	}
